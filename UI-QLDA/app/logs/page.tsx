      ...
      <div className="space-y-4">
        ...
        <div className="rounded-lg bg-card shadow-[0_2px_8px_rgba(0,0,0,0.08)]">
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-muted">
                  {["Thời gian", "Người dùng", "Chi nhánh", "Hành động", "Module", "Chi tiết", "Loại"].map((h) => (
              ...
              <tbody className="divide-y divide-border">
                {filteredLogs.map((log) => (
                  <tr key={log.id} className="hover:bg-muted/50">
                    ...
                    <td className="px-4 py-3 text-sm font-medium text-foreground whitespace-nowrap">{log.username}</td>
                    <td className="px-4 py-3 text-xs text-muted-foreground whitespace-nowrap">{log.maCN || "Hệ thống"}</td>
                    ...
                    <td className="px-4 py-3 text-sm text-muted-foreground max-w-[300px] truncate" title={log.details}>{log.details}</td>
                    <td className="px-4 py-3">
          ...
          <div className="flex items-center justify-between border-t border-border px-4 py-3">
            <p className="text-sm text-muted-foreground">Hiển thị {filteredLogs.length} bản ghi</p>
